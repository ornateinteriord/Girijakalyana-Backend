...
const getWelcomeMessage = (otherDetails, newRefNo) => {
      const welcomeSubject = "Welcome to GirijaKalyana!";
  const welcomeMessage = `
    <div style="font-family: Arial, sans-serif; padding: 20px; line-height: 1.6;margin-bottom: 100px;">
      <h2 style="color: #4A148C;">Welcome to <span style="color: #D81B60;">GirijaKalyana</span>!</h2>
      
      <p>Dear <strong>${otherDetails.first_name || ''}</strong>,</p>
      
      <p>Thank you for registering with <strong>GirijaKalyana</strong>.</p>
      ...
      <p style="margin-top: 30px;">
        Best regards,<br/>
        <strong>Team GirijaKalyana</strong>
      </p>
    </div>
  `;
...
const activatedSubject = "Your GirijaKalyana Profile is Now Active!";
...
const activatedMessage = `
  <div style="font-family: Arial, sans-serif; padding: 20px; line-height: 1.6; margin-bottom: 100px;">
    ...
    <p>You can now log in to your GirijaKalyana account and start exploring matches.</p>

    <p style="margin: 20px 0;">
      <a href="https://girija-kalyana.vercel.app" target="_blank"
...
const getResetPasswordMessage = (newOtp) => {
    const resetPasswordSubject = "GirijaKalyana - Password Recovery";
...
const getDeactiveMessage = (otherDetails) => {
  const deactivatedSubject = "Your GirijaKalyana Profile is Deactivated";
  const deactivatedMessage = `
    <div style="font-family: Arial, sans-serif; padding: 20px; line-height: 1.6; margin-bottom: 100px;">
      <h2 style="color: #D32F2F;">Profile Deactivated</h2>
      <p>Dear <strong>${otherDetails.first_name || ''}</strong>,</p>
      <p>Your profile has been <strong>deactivated</strong> on GirijaKalyana.</p>
